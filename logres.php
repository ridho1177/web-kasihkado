                                    ...
                                    <div class="card-body">
                                        <form action="login.php" id="login" method="POST">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" id="username" type="text" name="user" placeholder="Enter username" />
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <a href="register.php" class="btn btn-succes mt-4 text-center">Belum punya akun? Registerasi sekarang</a>
                                    </div>
                                </div>
                            </div>
                        </div>
