                                ...
                                <div class="card-footer d-flex align-items-center justify-content-center">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <a class="small text-white stretched-link" href="/team">View Details</a>
                                        </div>
                                    </div>
                                    <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                </div>
                            ...
                            <div class="card bg-danger text-white mb-4 text-center">
                                ...
                                <div class="card-footer d-flex align-items-center justify-content-center">
                                    <div class="row">
                                        <div class="col">
                                            <p>Jumlah Admin</p>
                                            <p><?php echo $record['admin'] ?></p>
                                            <a class="small text-white stretched-link" href="/pesan">View Details</a>
                                        </div>
                                    </div>
                                    <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                </div>
